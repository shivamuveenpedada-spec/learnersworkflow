...
export const ebooks: Ebook[] = [
  {
    ...
    coverImage: { src: "/images/placeholder/book-cover-a.svg", alt: "The Hungry Cat cover" },
    tier: "preschool",
    free: true,
    pages: [
      {
        ...
        illustration: { src: "/images/placeholder/animal-cat.svg", alt: "A hungry cat" },
        audio: silence,
      },
      {
        pageNumber: 2,
        text: "The cat looked for food everywhere.",
        illustration: { src: "/images/placeholder/animal-cat.svg", alt: "The cat searching" },
        audio: silence,
      },
      {
        pageNumber: 3,
        text: "She found a red apple on the table.",
        illustration: { src: "/images/placeholder/fruit-apple.svg", alt: "A red apple" },
        audio: silence,
      },
      {
        pageNumber: 4,
        text: "The cat ate the apple and felt happy.",
        illustration: { src: "/images/placeholder/animal-cat.svg", alt: "A happy cat" },
        audio: silence,
      },
    ],
  },
